...
> 这一环单独成篇（[第 3 篇](/2026/09/16/AI学习/传感器监控平台/03-真机接入与总线组网/)），并顺带把 RS485 总线原理讲清楚。
>
...
> [第 3 篇 · 真机接入与总线组网](/2026/09/16/AI学习/传感器监控平台/03-真机接入与总线组网/)。
...
> 见 [第 3 篇](/2026/09/16/AI学习/传感器监控平台/03-真机接入与总线组网/)。具体数值请从接口文档里读。
...
[第 2 篇](/2026/09/16/AI学习/传感器监控平台/02-串口链路打通与模拟器/) 的提示词会让智能体：
...
> [第 3 篇 · 真机接入与总线组网](/2026/09/16/AI学习/传感器监控平台/03-真机接入与总线组网/)。具体数值请从文档里读。
...
![系统架构](/images/传感器监控平台/00-architecture.svg)
...
![六步学习路径](/images/传感器监控平台/00-roadmap.svg)

| # | 文档 | 你会得到什么 | 提示词 |
| :---: | :--- | :--- | :---: |
| 1 | [环境搭建与项目骨架](/2026/09/16/AI学习/传感器监控平台/01-环境搭建与项目骨架/) | uv + Python 3.12 + 全套依赖 + 规范目录结构 | 1 |
| 2 | [串口链路打通与本地模拟器](/2026/09/16/AI学习/传感器监控平台/02-串口链路打通与模拟器/) | **读接口文档产出协议摘要** + 串口工具 + 免硬件的本地模拟器 | 2 |
| 3 | [真机接入与总线组网](/2026/09/16/AI学习/传感器监控平台/03-真机接入与总线组网/) | **RS485 总线原理 + 逐台改地址 + 统一波特率 + 集线器组网与总线联调** | 3 |
| 4 | [三个传感器驱动开发](/2026/09/16/AI学习/传感器监控平台/04-三个传感器驱动开发/) | 统一基类 + 三个驱动类 + 各自的调试脚本（**核心**） | 2 |
| 5 | [实时采集与控制后端](/2026/09/16/AI学习/传感器监控平台/05-实时采集与控制后端/) | FastAPI 服务：轮询采集 + 缓存 + WebSocket 推送 + 控制接口 | 1 |
| 6 | [前端网页与联调测试](/2026/09/16/AI学习/传感器监控平台/06-前端网页与联调测试/) | 单文件网页 + pytest 自动化测试 + 真机验收清单 | 2 |
...
![VSCode 运行按钮](/images/传感器监控平台/06-run-button.svg)
...
| **总线稳定性测试** | 300 轮轮询三台（[第 3 篇](/2026/09/16/AI学习/传感器监控平台/03-真机接入与总线组网/) 用） | `uv run python tools/bus_soak.py` | 第 3 篇后 |
...
保护措施（[第 3 篇](/2026/09/16/AI学习/传感器监控平台/03-真机接入与总线组网/) 的专用脚本 `tools/set_identity.py` 已把它们固化成代码，请照做）：
...
👉 [第 1 篇 · 环境搭建与项目骨架](/2026/09/16/AI学习/传感器监控平台/01-环境搭建与项目骨架/)
...
![三个传感器的关键寄存器速查](/images/传感器监控平台/03-registers.svg)
...
### A.5 改地址 / 改波特率要写哪个寄存器（[第 3 篇](/2026/09/16/AI学习/传感器监控平台/03-真机接入与总线组网/) 会用到）
